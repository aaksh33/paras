...
export default function Header() {
  ...
  return (
    <>
      {/* Sticky Navbar */}
      <header className="bg-white/95 backdrop-blur-sm fixed w-full top-0 z-50">
            ...
            <div className="flex items-center">
              <Link href="/" className="flex items-center space-x-2 group">
                ...
                <div className="flex flex-col">
                  <span className="text-gray-900 font-bold text-lg leading-tight group-hover:text-blue-600 transition-colors">
                    Harman Agro
                  </span>
      ...
      {/* Non-sticky Buy/Rent Buttons - Only on Home Page */}
      {pathname === '/' && (
        <div className="bg-gray-50 py-3 sm:py-4 border-t border-gray-100 mt-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
